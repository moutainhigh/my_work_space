...
class bishijie:
    ...
    def getDatas(self, timestampes):
        ...
        for item in all_div:
            ...
            self.dao.saveInfo(tableName="tbl_kuaixun", columesName="id,createtime,content,sourceurl,source",
                              values=insertStr)
    ...
    def update(self):
        self.ids = self.dao.getIdsBySource("tbl_kuaixun", utils.gettoday(),"币世界")
