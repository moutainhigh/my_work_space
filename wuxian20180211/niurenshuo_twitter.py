...
class twitter:
    ...
    def getDatas(self, index):
        ...
        for item in all_div:
            ...
            insertStr = "{},\"{}\",\"{}\",\"{}\"".format(infoId, name, infoDatetime, content)
            print(insertStr)
            self.dao.saveInfo(tableName="tbl_info", columesName="id,name,createtime,content", values=insertStr)
        return int(item['id'])
    ...
    def update(self):
        self.ids = self.dao.getIds("tbl_info", utils.gettoday())
